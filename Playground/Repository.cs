...
namespace RepositoryFramework
{
    public class Repository : IRepository
    {
        ...
        public IEnumerable<T> GetWithRawSql<T>(string query, params object[] parameters) where T : class
        {
            return GetSession().Database.SqlQuery<T>(query, parameters);
        }
